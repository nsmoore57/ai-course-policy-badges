...
| **AI Debugging Only** | Students may use AI to understand errors, diagnose problems, and ask guiding questions, but not to generate a full solution. | solid WT-style blue with wrench icon |
